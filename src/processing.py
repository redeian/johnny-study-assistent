...
def initialise_llms():
    ...
    load_dotenv()
    chat3_5 = ChatOpenAI(temperature = 0, model_name = "gpt-4o-mini", request_timeout = REQ_TIMEOUT)
...
def initialise_llms_with_key(api_key: str):
    from langchain.chat_models import ChatOpenAI
    load_dotenv()
    chat3_5 = ChatOpenAI(temperature = 0, model_name = "gpt-4o-mini", openai_api_key = api_key, request_timeout = REQ_TIMEOUT)
